...
public final class TestCaseRunner<J>
{
    ...
    public double runTakeMin(int timeMillis, TestCase tc, int iterations) throws Exception
    {
            // ruediger: 
            // 1. make this also time based (like warmup). 
            ...
            for (int i = 0; System.currentTimeMillis()-start < timeMillis ; i++) {
