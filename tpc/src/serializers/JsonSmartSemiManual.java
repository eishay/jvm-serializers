...
/**
 * Driver that uses json-smart [http://code.google.com/p/json-smart/], with semi-manual parsing.
 */
public class JsonSmartSemiManual
{
  public static void register(TestGroups groups)
  {
    groups.media.add(JavaBuiltIn.MediaTransformer,
        new SemiManualSerializer("json/json-smart/semi-manual"));
  }
