...
public class JaxbMedia implements java.io.Serializable {
	@XmlTransient
	public enum Player {
		JAVA, FLASH;
	...
	public JaxbMedia(String uri, String title, int width, int height, String format, long duration, long size, int bitrate, boolean hasBitrate, List<String> persons, Player player, String copyright)
	{
		this.uri = uri;
		this.title = title;
		this.width = width;
